...
public partial class ParserTests(ITestOutputHelper testOutput)
{
            ...
            Int32 newlineLength = 1)
    {
        ...
        var token = Microsoft.CodeAnalysis.CSharp.CSharpSyntaxTree
                             ...
                             .Single(
                                     t => t.RawKind is
                                             ...
                                             (Int32)Microsoft.CodeAnalysis.CSharp.SyntaxKind
                                                             .MultiLineRawStringLiteralToken or
                                             (Int32)Microsoft.CodeAnalysis.CSharp.SyntaxKind
                                                             .SingleLineRawStringLiteralToken);

        var templateString = TemplateString.Create(
                token,
        ...
        {
            TokenAssertionVisitor.Verify(
                    s,
                    "expected syntax was malformed");
        }
                                                                    ...
                                                                    new CodeBlockBodyChildSyntax(
                                                                            new RenderBlockSyntax(
                                                                                    new RenderBlockHeadSyntax(
                                                                                            new OpenRenderBlockSyntax(
                                                                                                    t.Next()),
                                                                                            new TextSyntax(
                                                                                            [
                                                                                                    new TextChildSyntax(
                                                                                                            new
                                                                                                                    NotEscapedTextSyntax(
                                                                                                                    [
                                                                                                                            new
                                                                                                                                    NotEscapedTextChildSyntax(
                                                                                                                                            new
                                                                            ...
                                                                            new RenderBlockSyntax(
                                                                                    ...
                                                                                    new RenderBlockBodySyntax(
                                                                                            ...
                                                                                            new TemplateBlockSyntax(
                                                                                                            ...
                                                                                                            LeadingTriviaSyntax(
                                                                                                                    new
                                                                                                                            WhitespacesSyntax(
                                                                                                                                    t.Next())),
                                                                                                    new
                                                                                                            OpenTemplateBlockSyntax(
                                                                                                                    t.Next()),
                                                                                                    new
                                                                                                            TemplateBlockBodySyntax(
                                                                                                            [
                                                                                                                    new
                                                                                                                            TemplateBlockBodyChildSyntax(
                                                                                                                                    new
                                                                                                                                            TextSyntax(
                                                                                                                                            [
                                                                                                                                                    new
                                                                                                                    ...
                                                                                                                    new
                                                                                                                            TemplateBlockBodyChildSyntax(
                                                                                                                                    new
                                                                                                                                            RenderBlockSyntax(
                                                                                                                                                    new
                                                                                                                                                            RenderBlockHeadSyntax(
                                                                                                                                                                    new
                                                                                                                                                                            OpenRenderBlockSyntax(
                                                                                                                                                                                    t.Next()),
                                                                                                                                                                    new
                                                                                                                                                                            TextSyntax(
                                                                                                                                                                            [
                                                                                                    ...
                                                                                                    new
                                                                                                            CloseTemplateBlockSyntax(
                                                                                                                    t.Next()),
                                                                                                    new
                                                                                                            TrailingTriviaSyntax(
                                                                                                                    new
                                                                                                                            NewlineSyntax(
                                                                                                                                    t.Next())))))),
                                                                    new CodeBlockBodyChildSyntax(
